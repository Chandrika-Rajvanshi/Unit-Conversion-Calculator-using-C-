...
void HeadingString(string &str, int N) //Function for heading
{ 
    for (int i = 0; i < N; i++) {
      ...
      cout<<"This tool enables you to easily convert physical units and quantities and makes calculations very easy!\n\n";
}

class Length // Length section
{
public:
double m;
...
void cmQ_mmQ ()
{ 
cout<<"Centi-Meter Cube: ";
cin>>p;
cout<<"In Milli-Meter Cube: "<<p*1000;
}
void mmQ_cmQ ()
{
cout<<"Milli-Meter Cube: ";
cin>>p;
cout<<"In Centi=Meter Cube: "<<p*.001;
}
void cmQ_mQ ()
{
cout<<"Centi-Meter Cube: ";
cin>>p;
cout<<"In Meter Cube: "<<p*.000001;
}
void mQ_cmQ ()
{
cout<<"Meter Cube: ";
cin>>p;
cout<<"In Centi-Meter Cube: "<<p*1000000;
}
void inchQ_mQ ()
{
cout<<"Cubic Inch: ";
cin>>p;
cout<<"In Meter Cube: "<<p*.00002;
}
void mQ_inchQ ()
{
cout<<"Meter Cube: ";
cin>>p;
cout<<"In Cubic Inch: "<<p*61023.74409;
}
void feetQ_mQ ()
{
cout<<"Cubic Feet: ";
cin>>p;
cout<<"In Meter Cube: "<<p*1222 ;
}
void mQ_feetQ ()
{
cout<<"Meter Cube: ";
cin>>p;
cout<<"In Cubic Feet: "<<p*123;
}
void mQ_gallon ()
{
cout<<"Meter Cube: ";
...
string str = "            UNIT CONVERSION CALCULATOR     ";
    int N = str.length();
    HeadingString(str, N);
do
{
...
cout<<"\n----------------";
cout<<"\n\nCompleted Successfully! \n\nPress Y(Yes to convert again) & N (NO to Exit)!\n";
cin>>i;
}
while(i!='n');
return 0;
